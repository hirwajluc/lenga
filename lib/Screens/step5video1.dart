...
class Step5Video1 extends StatelessWidget{
  @override
...
class _HomeState extends State<Home> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/ukoreshejephone.mp4');
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Kubitsa no gukoresha \namafaranga ukoresheje terefoni yawe",

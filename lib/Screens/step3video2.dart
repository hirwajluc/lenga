...
class Step3Video2 extends StatelessWidget{
  @override
...
class _HomeState extends State<Home> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/ahoubikaamafaranga.mp4');
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Aho ubika amafaranga yawe",

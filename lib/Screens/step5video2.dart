...
class Step5Video2 extends StatelessWidget{
  @override
...
class _HomeState extends State<Home> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/phonenkabank.mp4');
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Tangira ukoreshe \nterefoni yawe nka Banki",

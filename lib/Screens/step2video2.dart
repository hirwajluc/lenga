...
import 'package:lenga/Screens/subcategories2.dart';
...
class Step2Video2 extends StatelessWidget{
  @override
...
class _HomeState extends State<Home> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/inamayogukoraingengo.mp4');
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Inama zo gukora ingengo y\'imari",

...
class Step2Video1 extends StatelessWidget{
  @override
...
class _HomeState extends State<Home> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/ukowakoraingengo.mp4');
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Uko wakora ingengo y\'imari",
